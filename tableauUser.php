...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item" class="dashboard">
                        <a class="nav-link active" aria-current="page" href="tableau.php">
                    ...
                    <li class=" nav-item">
                        <a class="nav-link active" href="tableauCat.php">Category</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="tableauCustomers.php">Customers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="tabeauSuppliers.php">Suppliers</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="sales">
        ...
        $allstoc = $bdd->query('SELECT * FROM user ORDER BY id ASC');
        if (isset($_GET['s']) and !empty($_GET['s'])) {
            $recherche = htmlspecialchars($_GET['s']);
            $allstoc = $bdd->query('SELECT email  FROM  user WHERE email LIKE "%' . $recherche . '%" ORDER BY id ASC');
        }
        ...
        ?>
            ...
            <div class="container">
                <div class="row pt-3" style="display: inline-block;">
                    <a href="AddUser.php">
                    ...
                    ?>
                        ...
                        <input type="button" class="trash" value="Supprimer" name="trash"> -->
                                <div class="container mt-3">
                                    ...
                                    <a href="updateUser.php?id=<?= $stock['id'] ?>" class="m-2">
                                        <i class="fa fa-edit  fa-2x"></i>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="deleteUser.php?id=<?= $stock['id'] ?>">
                                                    <button class="btn btn-danger">Confirmer</button>
                                                </a>
