...
<body>
    ...
    <div class="demo">
        ...
        $allstoc = $bdd->query('SELECT * FROM out_stock ORDER BY id ASC');
        if (isset($_GET['s']) and !empty($_GET['s'])) {
            $recherche = htmlspecialchars($_GET['s']);
            $allstoc = $bdd->query('SELECT brand_name  FROM  out_stock WHERE brand_name LIKE "%' . $recherche . '%" ORDER BY id ASC');
        }
