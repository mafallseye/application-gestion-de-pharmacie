...
<body>
    ...
    <div>
        ...
        $allstoc = $bdd->query('SELECT * FROM suppliers ORDER BY id ASC');
        if (isset($_GET['s']) and !empty($_GET['s'])) {
            $recherche = htmlspecialchars($_GET['s']);
            $allstoc = $bdd->query('SELECT names  FROM  suppliers WHERE names LIKE "%' . $recherche . '%" ORDER BY id ASC');
        }
                        ...
                        <tr>
                            ...
                            <input type="button" class="trash" value="Supprimer" name="trash"> -->
                                <div class="container mt-3">
                                    ...
                                    <a href="updateSup.php?id=<?= $stock['id'] ?>" class="m-2">
                                        <i class="fa fa-edit  fa-2x"></i>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="deleteSup.php?id=<?= $stock['id'] ?>">
                                                    <button class="btn btn-danger">Confirmer</button>
                                                </a>
